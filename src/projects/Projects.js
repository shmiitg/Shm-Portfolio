...
const Projects = () => {
    const projects = [
        ...
        { name: 'Amazon Price Alert', info: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus consectetur similique soluta libero ducimusdignissimos, autem repellat necessitatibus illum ullam culpa, ex nemo, distinctio inventore.', tech: ['Chrome Extension', 'Express.js', 'Firebase', 'SendGrid'] },
        ...
        { name: 'Cricket Analytica', info: 'Expoloratory Data Analysis of IPL Ball Wise data in json format. This project lead me to runner up position in the Cricket Analytica Hackathon conducted by Coding Club, IIT Guwahati.', tech: ['EDA', 'Python', 'Matplotlib', 'Seaborn', 'Pandas', 'Numpy'] },
    ]
